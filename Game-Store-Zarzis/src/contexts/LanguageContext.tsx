...
export const translations: Translations = {
  ...
  // Client Auth
  "client.portal": { fr: "Espace Client", en: "Client Portal", ar: "بوابة العملاء" },
  "client.sms_login": { fr: "Connexion SMS Sécurisée", en: "Secure SMS Login", ar: "تسجيل دخول آمن عبر SMS" },
  "client.email_login": { fr: "Connexion Email Sécurisée", en: "Secure Email Login", ar: "تسجيل دخول آمن عبر البريد" },
  "client.create_account": { fr: "Créer un nouveau compte", en: "Create a new account", ar: "إنشاء حساب جديد" },
  ...
  "client.email_address": { fr: "Adresse email", en: "Email Address", ar: "عنوان البريد الإلكتروني" },
  ...
  "client.verify_login": { fr: "Vérifier & Connexion", en: "Verify & Login", ar: "تحقق وسجل الدخول" },
  "client.verify_register": { fr: "Vérifier & Inscription", en: "Verify & Register", ar: "تحقق وسجل" },
  ...
  "gaming.offer": { fr: "🎮 Achetez 5 parties, la 6ème est offerte!", en: "🎮 Buy 5 games, get the 6th FREE!", ar: "🎮 اشتري 5 ألعاب واحصل على السادسة مجاناً!" },
