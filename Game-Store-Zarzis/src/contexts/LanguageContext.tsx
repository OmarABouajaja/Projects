...
export const translations: Translations = {
  ...
  "expenses.subtitle": { fr: "Gérer les coûts d'exploitation.", en: "Manage operating costs.", ar: "إدارة تكاليف التشغيل." },
  "expenses.add_button": { fr: "Ajouter une dépense", en: "Add Expense", ar: "إضافة مصروف" },
  "expenses.daily_month": { fr: "Journalier (Ce mois)", en: "Daily (This Month)", ar: "يومي (هذا الشهر)" },
  "expenses.monthly_fixed": { fr: "Fixe Mensuel", en: "Monthly Fixed", ar: "ثابت شهري" },
  "expenses.total_yearly": { fr: "Total Annuel (Pro)", en: "Total Yearly (Pro)", ar: "إجمالي سنوي (للمحترفين)" },
  "expenses.list_title": { fr: "Liste des dépenses", en: "Expense List", ar: "قائمة المصاريف" },
  ...
  "expenses.no_expenses": { fr: "Aucune dépense trouvée pour cette catégorie.", en: "No expenses found for this category.", ar: "لم يتم العثور على مصاريف لهذه الفئة." },
  "expenses.add_title": { fr: "Ajouter une nouvelle dépense", en: "Add New Expense", ar: "إضافة مصروف جديد" },
