...
else if(t == 'R'){      //turn LEFT  (diagonals wheels turn same direction to turn 360° )
  //---//forward:
  digitalWrite(flf,HIGH);
  digitalWrite(frf,LOW);
  digitalWrite(rlf,HIGH);
...
else  if(t == 'L'){      //turn RIGHT (diagonals wheels turn same direction to turn 360° )
  //---//forward:
  digitalWrite(flf,LOW);
  digitalWrite(frf,HIGH);
  digitalWrite(rlf,LOW);
...
else if(t == 'J'){      //turn LEFT-FORWARD (all wheels turn forward except the front Right one)
  //---//forward:
  digitalWrite(flf,HIGH);
  digitalWrite(frf,LOW);
  digitalWrite(rlf,HIGH);
...
else  if(t == 'I'){      //turn RIGHT-FORWARD (all wheels turn forward except the front Left one)
  //---//forward:
  digitalWrite(flf,LOW);
  digitalWrite(frf,HIGH);
  digitalWrite(rlf,HIGH);
